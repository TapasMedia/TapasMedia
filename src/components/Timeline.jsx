  ...
  return (
    <div className="flex justify-center bg-neutral-950 items-center flex-col py-14 w-screen">
      <div className="flex -translate-x-7">
        ...
        />
        <WordPullUp
          className="tracking-[10] text-xl md:text-3xl lg:text-4xl font-normal text-yellow-400"
          words="Process"
        />
        <WordPullUp
          className="tracking-[10] text-xl md:text-3xl lg:text-4xl font-light"
      ...
      <div className="flex">
        <WordPullUp
          className="tracking-[10] text-3xl md:text-5xl lg:text-7xl font-normal text-yellow-400"
          words="Amplify"
        />
        <WordPullUp
        ...
        />
        <WordPullUp
          className="tracking-[10] md:text-5xl text-3xl lg:text-7xl text-yellow-400"
          words="Go Big !"
        />
      </div>
