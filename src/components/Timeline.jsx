...
const TimelinePage = () => {
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            ...
            growth, creating meaningful engagement and setting you apart from
            the competition.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
  ...
  return (
    <div
      className="flex justify-center bg-neutral-950 items-center flex-col py-14 w-screen"
      id="steps"
    >
